...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='RHseg/CanPrairies_2010_FCC_SR';
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='NGreatPlains_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30,
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='RHseg/NGreatPlains_2010_FCC_SR';
Export.image.toAsset({
  image: out_img,
  scale: 30,
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='Heartland_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='RHseg/Heartland_2010_FCC_SR';
Export.image.toAsset({
  image: out_img,
  scale: 30,
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='NBasinRange_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='NWRim_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='SBasinRange_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='SERim_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='SWRim_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='RHseg/SWRim_2010_FCC_SR';
Export.image.toAsset({
  image: out_img,
  scale: 30,
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='WBasinRange_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='WCrescent_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='SPrairies_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='SGreatPlains_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='NPrairies_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='Mississippi_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='MidUplands_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='MidSeaBoard_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='EUplands_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='ESeaBoard_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='ECrescent_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
...
var input=makeRHSEGImageSR(studyArea);
var out_img=input.multiply(256).byte();
var out_name='MidCrescent_2010_FCC_SR';
Export.image.toDrive({
  image: out_img,
  scale: 30, folder:'NorthAmericaAGZoneRHsegData',
  maxPixels:9999999999900,
