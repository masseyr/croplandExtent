...
var image = ee.Image("users/images/Yukon_2010_v1"),
    image2 = ee.Image("users/images/NWForest_2010_v1"),
    image3 = ee.Image("users/images/CanPrairies_2010_v1"),
    image4 = ee.Image("users/images/MidEasternForest_2010_v1"),
    image5 = ee.Image("users/images/NovaScotia_2010_v1"),
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-113.07008743286133, 53.04513483308966],
                  ...
                  [-113.04914474487305, 53.01922375720109],
    ...
    image6 = ee.Image("users/images/reference/aafc_annual_crop_inventory_2009-12_cnc_east_envi_geo__"),
    image7 = ee.Image("users/images/reference/aafc_annual_crop_inventory_2009-12_cnc_west_envi_geo__");
/***** End of imports. If edited, may not auto-convert in the playground. *****/
var counties=ee.FeatureCollection('ft:1Qm8mjuAEwHPcEd9BHbo7py3VeJa1Ycl2w9ni3fBZ')

var mosaic_2010=ee.ImageCollection([image,image2,image3,image4,image5])
.map(function(img){return img.byte().rename('classification')})
.qualityMosaic('classification')

//Map.addLayer(mosaic_2010,{palette:'00ff00'},'map_2010')
//Map.addLayer(mosaic_2010,{palette:'ffff00'},'map_2010')
...
var out_img1=applyMask(cut1,canada,mosaic_2010)

var out_img2=mosaic_2010

var crop=ee.ImageCollection([out_img1,out_img2]).mosaic()

var ref=ee.ImageCollection([image6,image7]).mosaic()
ref=ref.updateMask(ref.eq(1))

//Map.addLayer(ref,{palette:'00ffff,0000ff'})
...
Export.table.toDrive({
  ...
  folder: 'outputStats',
  fileNamePrefix: 'Canada_2010_nom_county_Stat_ha1',
  fileFormat: 'CSV'
});
...
var Ref_px = ref.multiply(ee.Image.pixelArea().divide(10000))


var class_stat= Ref_px.reduceRegions({
  collection:counties,
  reducer:ee.Reducer.sum(),
  scale:90
})
...
Export.table.toDrive({
  ...
  description: 'class_stat',
  folder: 'outputStats',
  fileNamePrefix: 'Canada_2010_ref_county_Stat_ha1',
  fileFormat: 'CSV'
});